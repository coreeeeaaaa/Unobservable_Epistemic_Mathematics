...
| Observed embedding facts (injective, not surjective) | `obsInclusion_injective`, `obsInclusion_not_surjective`, `observed_operator_equiv` | `Lean4/UemProofs/UEM/UEM_ObservedEmbedding.lean` | OK |
| Carrier nonempty (core model witness) | `carrier_nonempty` | `Lean4/UemProofs/UEM/UEM_ObservedEmbedding.lean` | OK |

...
| Observed embedding (injective, not surjective) | `obsInclusion_injective`, `obsInclusion_not_surjective`, `observed_operator_equiv` | `Lean4/UemProofs/UEM/UEM_Conservativity.lean` | OK |
